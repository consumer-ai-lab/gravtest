...
Open [http://15.206.171.251:3000](http://15.206.171.251:3000) to view it in the browser.
...
- Build Image
```bash
docker build --tag YOUR-USER-NAME/wcl_frontend .
```
...
```bash
docker run -p 3000:3000 YOUR-USER-NAME/wcl_frontend
```
...
- Stop once done
```bash
docker stop YOUR-USER-NAME/wcl_frontend
```

- Upload image to docker hub
```bash
docker push YOUR-USER-NAME/wcl_frontend
```
...
```bash
docker pull YOUR-USER-NAME/wcl_frontend
```

- Run Image at port 3000
```bash
docker run -d -p 3000:3000 YOUR-USER-NAME/wcl_frontend
```
